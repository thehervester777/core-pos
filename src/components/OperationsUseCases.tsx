  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        ...
        {/* Content Box */}
        <div className="bg-white/80 border border-blue-200/70 rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-12 backdrop-blur-2xl shadow-[0_20px_50px_rgba(37,99,235,0.08),0_1px_2px_rgba(255,255,255,0.95)_inset]">
          {/* Retail & Grocery */}
          {activeTab === 'retail' && (
